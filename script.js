...
function processDebuff(forcedName=null) {
  ...
  playSound('debuff');
  showVisualEffect('debuff','🛑',name,'Неблагоприятное событие',950,true);
...
function achievements(finalFish,total) {
  ...
  if (state.castClicks>=11) a.push('Марафонец');
...
const GUIDE = {
  ...
  'Достижения': [
    ...
    ['Марафонец','Совершить не менее 11 фактических забросов за одну игру.'],
